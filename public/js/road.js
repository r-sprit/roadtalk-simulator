...
road.prototype.getRoadVehcilesJson = function() {
	var vehicles_json = [];
	console.log(this.veh.length);
	for (i = 0; i<this.veh.length; i++) {
        vehicles_json.push(
			{
                "roead_id": this.roadID,
				"car_id" : this.veh[i].id,
				"speed": this.veh[i].speed,
				"acc" : this.veh[i].acc,
				"x" : this.veh[i].xCenterPix,
				"y" : this.veh[i].yCenterPix,
                "current_lane" : this.veh[i].lane,
                "past_lane" : this.veh[i].laneOld
...
road.prototype.updateEnvironment=function(){
    //console.log("Updaing Enviroment");
    for(var i=0; i<this.veh.length; i++){
...
road.prototype.drawVehicles=function(carImg, truckImg, obstacleImg, scale,
    ...
    //console.log("Drawing Vehciles: Total Vehicles " + this.veh.length);
    ...
    for(var i=0; i<this.veh.length; i++){
        ...
        if(filterPassed){
            ...
            this.veh[i].xCenterPix = xCenterPix;
            this.veh[i].yCenterPix = yCenterPix;
